...
func TestCollection_List(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			collection := Collection[map[string]any]{tt.client, tt.collection, defaultClient.PocketbaseURL + "/api/collections/" + tt.collection}
...
func TestCollection_Delete(t *testing.T) {
	...
	collection := Collection[map[string]any]{client, migrations.PostsPublic, client.PocketbaseURL + "/api/collections/" + "collectionname"}
...
func TestCollection_Create(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			collection := Collection[any]{tt.client, tt.collection, defaultClient.PocketbaseURL + "/api/collections/" + tt.collection}
